...
import com.fisc.decldoccomptable.DecldoccomptableApp;
...
@SpringBootTest(classes = DecldoccomptableApp.class)
@DirtiesContext(classMode = DirtiesContext.ClassMode.BEFORE_CLASS)
public class DecldoccomptableKafkaResourceIT {
    ...
    @Autowired
    private DecldoccomptableKafkaProducer producer;

    @Autowired
    private DecldoccomptableKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        DecldoccomptableKafkaResource kafkaResource = new DecldoccomptableKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/decldoccomptable-kafka/publish?message=test"))
